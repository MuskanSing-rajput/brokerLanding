      ...
      <div ref={firstHeroRef} className="relative w-full h-screen z-10 flex flex-col gpu-accelerated overflow-hidden">
        ...
        <main className="relative z-10 flex-grow flex flex-col items-center pt-[140px] px-4 w-full max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12 w-full sm:w-auto">
            <Link href="https://dev.uptrender.in/register" className="inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-[#A4FE46] to-[#10B981] hover:from-[#10B981] hover:to-[#059669] text-white px-8 py-4 rounded-xl font-semibold shadow-[0_0_25px_rgba(164,254,70,0.4)] hover:scale-105 transition-all w-full sm:w-auto min-w-[180px]">
      ...
      <section ref={secondHeroRef} className="relative w-full h-screen flex items-center bg-black border-t border-white/5 z-20 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.8)]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 w-full pt-20 pb-20">
          ...
          <div className="text-left max-w-3xl">
            ...
            <Link href="https://dev.uptrender.in/login" className="inline-flex items-center justify-center space-x-2 bg-[#A4FE46] text-black w-full sm:w-auto px-8 py-4 rounded-xl font-bold hover:bg-[#8ee036] transition-all shadow-[0_0_25px_rgba(164,254,70,0.4)] hover:scale-105">
        ...
        <div className="gsap-cards-container relative w-full max-w-[1140px] mx-auto h-[650px] sm:h-[600px] md:h-[550px] lg:h-[500px] mb-8 lg:mb-16 px-4 overflow-hidden">
          ...
          <div className="gsap-card absolute inset-x-4 top-0 bottom-0 z-10 bg-[#0c0c0e]/98 border border-white/10 rounded-[32px] p-5 sm:p-8 md:p-12 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:gap-10 shadow-[0_30px_70px_rgba(0,0,0,0.95)] transition-[border-color,background-color,box-shadow] duration-300 overflow-hidden">
            <div className="flex-1 space-y-3 sm:space-y-6">
              ...
              <Link href="https://dev.uptrender.in/login" className="inline-flex items-center space-x-2 bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2.5 md:px-6 md:py-3 rounded-xl text-[10px] md:text-xs font-semibold text-white transition-all">
